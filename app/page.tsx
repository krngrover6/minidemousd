...
function ScreenCard({src,title,children}:{src:string;title:string;children:React.ReactNode}){return <details className="screen-card"><summary><img src={src} alt={title}/><span><b>{title}</b><small>Click to understand this screen</small></span><ChevronRight/></summary><div>{children}</div></details>}
